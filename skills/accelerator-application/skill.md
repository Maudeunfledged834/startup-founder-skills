...
| Launch Accelerator (Jason Calacanis) | $100K | 6% | 3 months | San Francisco | Rolling | Consumer and SaaS, media exposure via TWIST network |
...
| MassChallenge | Social impact, any sector | $0 (no equity) | Boston, multiple |
...
|---------|-------|----------|
| StartX (Stanford) | Stanford-affiliated | Palo Alto |
| Creative Destruction Lab | Science-based ventures | Multiple |
| NSF I-Corps | Deep tech commercialization | National |
| SBIR/STTR | Government R&D grants | National |
